...
const CACHE_NAME = 'arabic-hub-v1.0.2';
const STATIC_CACHE = 'arabic-static-v1.1.2';
const DYNAMIC_CACHE = 'arabic-dynamic-v1.1.2';
...
self.addEventListener('push', (event) => {
    ...
    const options = {
        body: data.body || 'محتوى جديد متاح في مركز تعليم العربية',
    ...
    event.waitUntil(
        self.registration.showNotification(data.title || 'مركز تعليم العربية', options)
    );
});
